...
# Package meta-data.
NAME = 'apeiron'
DESCRIPTION = 'Starter project for common development tasks'
...
REQUIRED = [
     'nose', 'sphinx', 'jinja2', 'click', 'click-plugins', 'matplotlib', 'reportlab', 'zeep', 'requests', 'xmljson', 'beautifulsoup4'
]
